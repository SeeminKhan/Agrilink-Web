        ...
        <div className="relative rounded-3xl overflow-hidden" style={{ background: 'linear-gradient(135deg, #0D592A 0%, #0a4721 100%)' }}>
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8 px-8 sm:px-12 py-14">
            <div className="text-center lg:text-left">
              ...
              <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-3">{t('cta.title')}</h2>
              <p className="text-green-100 max-w-lg">{t('cta.subtitle')}</p>
            </div>

            <div className="flex flex-col sm:flex-row gap-4 shrink-0">
              <Link to="/login" className="flex items-center justify-center gap-2 bg-white font-bold px-7 py-3.5 rounded-xl hover:bg-gray-50 transition shadow-lg"
                style={{ color: '#0D592A' }}>
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 border-2 border-white/40 text-white font-bold px-7 py-3.5 rounded-xl hover:bg-white/10 transition">
