    ...
    <section className="py-20" style={{ background: 'linear-gradient(135deg, #f0f7f3 0%, #e8f5ee 100%)' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <span className="font-semibold text-sm uppercase tracking-widest" style={{ color: '#0D592A' }}>Testimonials</span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mt-2">
            Trusted by <span style={{ color: '#0D592A' }}>Thousands</span>
          </h2>
          <p className="text-gray-500 mt-3 max-w-xl mx-auto">
            Real stories from farmers and buyers who've transformed their agricultural business with AgriLink.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map(t => (
            <div key={t.name} className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-lg transition-shadow relative">
